...
import styles from "./QuillEditorTNBT_DefaultCss.module.scss";
const cx = classNames.bind(styles);
import { QuillEditorTNBTProps, QuillEditorRef, EditorData, ImageData } from "../types";

const QuillEditorTNBT_DefaultCss = React.forwardRef<QuillEditorRef, QuillEditorTNBTProps>((props, ref) => {
  const {
    value,
    defaultValue,
    onChange,
      ...
      <div className={cx("container-create-article")}>
        ...
        <div className={cx("add-body")}>
          <div className={cx("box-toolbar")}>
            <div className={cx("write-btn", currentMode === "write" ? "write-active" : "")} onClick={handleWrite}>
              <p style={{ padding: "5px 10px", color: currentMode === "write" ? "rgb(27, 117, 170)" : "black", fontWeight: "500" }}>Write</p>
            </div>
            <div className={cx("preview-btn", currentMode === "preview" ? "preview-active" : "")} onClick={handlePreview}>
              <p style={{ padding: "5px 10px", color: currentMode === "preview" ? "rgb(27, 117, 170)" : "black", fontWeight: "500" }}>Preview</p>
            </div>
          </div>
...
QuillEditorTNBT_DefaultCss.displayName = "QuillEditorTNBT";

export default QuillEditorTNBT_DefaultCss;
